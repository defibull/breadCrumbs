//
//  TTViewControllerforTableViewController.swift
//  BeaconNextCopy
//
...
class TTViewControllerforTableViewController: UIViewController,UITextFieldDelegate {
    ...
    weak var tableView:TTCommentsTableViewController?
    
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        
        if segue.identifier == "tablo"
        {
            tableView  = segue.destinationViewController as? TTCommentsTableViewController
