//
//  TTCommentsTableViewController.swift
//  BeaconNextCopy
//
...
class TTCommentsTableViewController: UITableViewController {
        ...
        override func viewDidLoad() {
            ...
            let newObject = "Wow ! I love this rooftop garden"
        ...
        func insertNewObject(name : String) {
            print("table view's stuff got called")
            objects.insert(name, atIndex: 1)
        ...
        */
        ...
        override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
            let cell = tableView.dequeueReusableCellWithIdentifier("mala", forIndexPath: indexPath)
